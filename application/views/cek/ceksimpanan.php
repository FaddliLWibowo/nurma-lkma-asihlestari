    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#home" data-toggle="tab">Simpanan</a></li>
                <li><a href="#home" data-toggle="tab">Pinjaman</a></li>
            </ul>
            <br/>
            <div class="row">
                <div class="col-md-12">
            ...
            <table class="table table-striped">
                ...
                foreach($mutasi as $m):
                    ...
                    echo '<td><a onclick="return confirm(\'yakinkan dulu\')" class="btn btn-default btn-xs" href="'.site_url('cek/delAksiSimpanan/'.$m['id_aksi']).'">hapus</a></td>';
                    echo '</tr>';
                endforeach;
                ?>
            </table>
